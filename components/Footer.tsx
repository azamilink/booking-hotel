					...
					<div>
						...
						<form
							...
							<div className='mb-5'>
								<input
									type='email'
									className='w-full px-4 py-3 rounded-md focus:outline-none bg-white'
									placeholder='jhondoe@gmail.com'
								/>
							</div>
							<button className='w-full bg-orange-400 p-3  hover:bg-orang-500 text-white text-center rounded-sm '>Suscribe</button>
						</form>
					</div>
				</div>
			</div>

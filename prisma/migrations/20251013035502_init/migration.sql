...
-- AddForeignKey
ALTER TABLE "RoomAmenities" ADD CONSTRAINT "RoomAmenities_amenitieId_fkey" FOREIGN KEY ("amenitieId") REFERENCES "Amenities"("id") ON DELETE CASCADE ON UPDATE CASCADE;

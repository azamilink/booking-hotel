	...
	return (
		<div className='bg-white p-8 rounded-sm shadow-sm'>
			...
			<form action={formAction}>
				<div className='grid md:grid-cols-2 gap-7 mt-6'>
					<div>
						<input
							type='text'
							name='name'
							className='bg-gray-50 border border-gray-200 rounded-sm w-full font-light p-2'
							placeholder='Name*'
						/>
						<div
							arial-live='polite'
				...
				<button
					type='submit'
					className='px-10 py-4 text-center font-semibold text-white w-full bg-orange-400 rounded-sm hove:bg-orange-500 cursor-pointer'>

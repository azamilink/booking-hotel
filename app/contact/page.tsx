			...
			<div className='max-w-screen-xl mx-auto py-20 px-4'>
				<div className='grid md:grid-cols-2 gap-8'>
					<div>
						...
						<p className='text-gray-700 py-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, nihil placeat? Est suscipit necessitatibus exercitationem!</p>
						<ul className='list-item space-x-6 pt-8'>
							...
							<li className='flex gap-5'>
								...
								<div className='flex-1'>
									...
									<p>+99742 456-7890, +8743 456-7890</p>
								</div>
							</li>
							<li className='flex gap-5'>
								<div className='flex-none bg-gray-300 p-3 shadow-sm rounded-sm'>
								...
								<div className='flex-1'>
									...
									<p>code Street road 2390, PDG, Indonesia</p>
								</div>
							</li>
						</ul>
					</div>

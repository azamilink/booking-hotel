		...
		<form action=''>
			<div className='grid md:grid-cols-12 ga'>
				...
				<div className='col-span-4 bg-white p-4'>
					<label
						htmlFor='input-file'
						className='flex flex-col mb-4 items-center justify-center aspect-video border-2 border-gray-300 border-dashed rounded-mb cursor-pointer bg-gray-50 relative'>
						<div className='flex flex-col items-center justify-center text-gray-500 pt-5 pb-6 z-10'>
							...
							{image ? (
								<button
									...
									className='flex items-center justify-center bg-tranparent size-6 rounded-sm absolute right-1 top-1 text-white hover:bg-red-400'>
